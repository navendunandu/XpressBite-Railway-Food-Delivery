    ...
    <?php
        if (isset($_POST["btn_checkout"])) {                 
                ...
                if($con->query($updQry)){   
                    ?>
                    <script>
                    window.location="AddBooking.php?bid=<?php echo $bookingId ?>";
                    </script>
                    <?php
                }
        }
        ...
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
            ...
            $res = $con->query($sel);
                while ($row=$res->fetch_assoc()) {
                   $selPr = "select * from tbl_food f inner join tbl_category c on c.category_id=f.category_id where f.food_id='" .$row["food_id"]. "'";
            ...
            <div class="product">
                <div class="product-image">
                    <img
                        src="../Assets/Files/Restaurant/<?php echo $food["food_photo"] ?>"
                        />
                </div>
                ...
                <div class="product-price "	><?php echo $food["food_price"] ?></div>
                <div class="product-quantity">
                    <input type="number" name="txtqty" id="<?php echo $row["cart_id"]?>" value='<?php echo $row["cart_qty"]?>' min='1' style="width:90px">
                </div>
            ...
            <div class="totals">
                ...
                <button type="submit" class="checkout" name="btn_checkout">Proceed</button>
